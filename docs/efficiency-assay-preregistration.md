...
Executable derivation: `src/derive_efficiency_breakpoints.py`. Preserved output: `results/efficiency-breakpoints.txt` (seed 123, 2000 ticks per test, 25 bisection iterations).
